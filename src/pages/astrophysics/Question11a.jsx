...
const QUESTION_ID = "9702-41-ALA26-Q11a";

export default function AstroQuestion11a() {
...
Mark scheme:
- B1 mark 1: the total power of radiation emitted by the star
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "total power of radiation emitted by the star", "found": true or false, "feedback": "one sentence explanation" },
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/astrophysics/q8ai")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
