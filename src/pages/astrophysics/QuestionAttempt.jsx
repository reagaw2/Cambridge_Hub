...
export default function AstroQuestionAttempt() {
  ...
  const handleSubmit = async () => {
    ...
    navigate("/feedback", { state: { feedback: fb, answer, topicKey: question.topic_key, questionId: question.id, nextFullRoute: "/astrophysics/question", nextRetryRoute: "/astrophysics/question", backRoute: "/physics", paperRef: question.paper_ref } });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col gap-4 p-4">
          ...
          <DevQuestionJumper allQuestions={ASTROPHYSICS_QUESTIONS} onJump={(q) => { setOverrideQuestion(q); setAnswer(""); setShowTeachMe(false); setError(null); }} />
        </div>
      </div>
