...
const QUESTION_ID = "w25_44_Q10b";

export default function AstroSimilarQuestion() {
...
- B1 mark 2: galaxies moving apart means the universe must be expanding
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "galaxies show redshift so they are moving apart", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "galaxies moving apart means universe is expanding", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/astrophysics/familiarity-check",
        nextRetryRoute: "/astrophysics/similar-question",
        backRoute: "/astrophysics/question",
        paperRef: PAPER_REF,
      }
    });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/astrophysics/question")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
