...
const QUESTION_ID = "9702-41-ALA26-Q6a";

export default function CapacitanceQuestion6a() {
...
Mark scheme:
- M1 mark 1: capacitance = charge divided by potential difference (C = Q/V)
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "charge divided by potential difference (C = Q/V)", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "charge on one plate / p.d. between the plates", "found": true or false, "feedback": "one sentence explanation — cannot be awarded unless mark 1 is also awarded" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextRetryRoute: "/capacitance/q6a",
        backRoute: "/",
        paperRef: PAPER_REF,
      }
    });
