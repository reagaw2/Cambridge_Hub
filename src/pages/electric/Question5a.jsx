...
const QUESTION = {
  ...
  text: "State the relationship between electric field and electric potential.",
  marks: "[2 marks]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "electric_fields";
const QUESTION_ID = "9702-41-ALA26-Q5a";

export default function ElectricQuestion5a() {
...
Question: State the relationship between electric field and electric potential.
Mark scheme:
- M1 mark 1: electric field equals the negative potential gradient, or E = negative dV/dr
- A1 mark 2: reference to the negative sign — field points in direction of decreasing potential
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "electric field equals potential gradient", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "negative sign / field in direction of decreasing potential", "found": true or false, "feedback": "one sentence explanation — cannot be awarded unless mark 1 is also awarded" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/electric/q5b",
        nextRetryRoute: "/electric/q5a",
        backRoute: "/",
        paperRef: PAPER_REF,
      }
    });
