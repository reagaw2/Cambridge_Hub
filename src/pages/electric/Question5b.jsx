...
const QUESTION = {
  ...
  text: "Two charged isolated insulating spheres X and Y are near to each other. P is a point on the line joining the centres of the spheres. Explain why it is NOT possible for the total electric potential and the resultant electric field to simultaneously be zero at point P.",
  marks: "[3 marks]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "electric_fields";
const QUESTION_ID = "9702-41-ALA26-Q5b";

export default function ElectricQuestion5b() {
...
Question: Two charged spheres X and Y are near each other. P is on the line joining their centres. Explain why it is NOT possible for the total electric potential and the resultant electric field to simultaneously be zero at point P.
Mark scheme — any three of the following:
- B1: for potential to be zero the charges must have opposite signs
- B1: for field to be zero the fields due to X and Y must be in opposite directions so charges must have the same sign
- B1: the signs of the charges cannot simultaneously be both the same and opposite — so it is not possible
...
Analyse the student's answer against the mark scheme. Award 1 mark for each distinct valid point up to 3. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "for potential = 0: charges must have opposite signs", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "for field = 0: charges must have same sign", "found": true or false, "feedback": "one sentence explanation" },
  "mark_3": { "earned": true or false, "keyword": "contradiction — charges cannot be same sign and opposite sign simultaneously", "found": true or false, "feedback": "one sentence explanation" },
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/electric/q5a")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
