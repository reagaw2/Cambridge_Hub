...
import { getNextForcesQuestion, advanceForcesIndex } from "@/lib/forcesBank";
...
export default function ForcesQuestionAttempt() {
  ...
  const { question, idx, total } = getNextForcesQuestion();
  ...
  const handleSubmit = async () => {
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/forces/question",
        nextRetryRoute: "/forces/question",
        backRoute: "/physics",
