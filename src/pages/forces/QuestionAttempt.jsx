...
export default function ForcesQuestionAttempt() {
  ...
  const queued = getNextForcesQuestion();
  ...
  const handleSubmit = async () => {
    ...
    advanceForcesIndex();
    navigate("/feedback", { state: { feedback: fb, answer, topicKey: question.topic_key, questionId: question.id, nextFullRoute: "/forces/question", nextRetryRoute: "/forces/question", backRoute: "/physics", paperRef: question.paper_ref } });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col gap-4 p-4">
          ...
          <DevQuestionJumper allQuestions={FORCES_QUESTIONS} onJump={(q) => { setOverrideQuestion(q); setAnswer(""); setError(null); }} />
        </div>
      </div>
