...
export default function KinematicsQuestionAttempt() {
  ...
  const queued = getNextKinematicsQuestion();
  ...
  const handleSubmit = async () => {
    ...
    advanceKinematicsIndex();
    navigate("/feedback", { state: { feedback: fb, answer, topicKey: question.topic_key, questionId: question.id, nextFullRoute: "/kinematics/question", nextRetryRoute: "/kinematics/question", backRoute: "/physics", paperRef: question.paper_ref } });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col gap-4 p-4">
          ...
          <DevQuestionJumper allQuestions={KINEMATICS_QUESTIONS} onJump={(q) => { setOverrideQuestion(q); setAnswer(""); setError(null); }} />
        </div>
      </div>
