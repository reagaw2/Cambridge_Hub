...
import { getNextKinematicsQuestion, advanceKinematicsIndex } from "@/lib/kinematicsBank";
...
export default function KinematicsQuestionAttempt() {
  ...
  const { question, idx, total } = getNextKinematicsQuestion();
  ...
  const handleSubmit = async () => {
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/kinematics/question",
        nextRetryRoute: "/kinematics/question",
        backRoute: "/physics",
