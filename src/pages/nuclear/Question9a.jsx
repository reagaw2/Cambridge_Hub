...
const QUESTION = {
  ...
  text: "Polonium-211 decays by alpha emission to form a stable isotope of lead. Write a complete nuclear equation for this decay.",
  marks: "[2 marks]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "nuclear_physics";
const QUESTION_ID = "9702-41-ALA26-Q9a";

export default function NuclearQuestion9a() {
...
Question: Write the nuclear equation for alpha decay of polonium-211 to lead.
Mark scheme:
- B1 mark 1: mass number of Pb = 207 and proton number of Pb = 82
- B1 mark 2: mass number of alpha = 4 and proton number of alpha = 2
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "207 and 82 for lead", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "4 and 2 for alpha particle", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/nuclear/q9cii",
        nextRetryRoute: "/nuclear/q9a",
        backRoute: "/",
        paperRef: PAPER_REF,
      }
    });
