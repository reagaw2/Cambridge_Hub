...
const QUESTION = {
  label: "Question 9(c)(ii)",
  topic: "Nuclear Physics",
  text: "Suggest why the total amount of energy released by the decay process is greater than the energy given to the alpha particles alone.",
  marks: "[1 mark]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "nuclear_physics";
const QUESTION_ID = "9702-41-ALA26-Q9cii";

export default function NuclearQuestion9cii() {
...
Question: Suggest why the total energy released by the decay process is greater than the energy given to the alpha particles.
Mark scheme:
- B1 mark 1: lead nuclei also have recoil kinetic energy OR gamma photons are also emitted carrying energy
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "lead nuclei have recoil kinetic energy OR gamma photons are also emitted", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/",
        nextRetryRoute: "/nuclear/q9cii",
        backRoute: "/nuclear/q9a",
        paperRef: PAPER_REF,
      }
    });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/nuclear/q9a")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
