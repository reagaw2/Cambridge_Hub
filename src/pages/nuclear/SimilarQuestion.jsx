...
const QUESTION = {
  ...
  text: "In the decay equation of oxygen-15, a particle Z is produced alongside the daughter nucleus and a positron. State the name of particle Z.",
  marks: "[1 mark]",
};

export default function NuclearSimilarQuestion() {
...
Question: In the decay equation of oxygen-15, a particle Z is produced alongside the daughter nucleus and a positron. State the name of particle Z.
Mark scheme:
- B1 mark 1: electron neutrino
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "electron neutrino", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        questionId: "w25_44_Q8bii",
        nextFullRoute: "/nuclear/familiarity-check",
        nextRetryRoute: "/nuclear/similar-question",
