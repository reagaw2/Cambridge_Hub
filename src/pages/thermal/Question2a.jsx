...
const QUESTION_ID = "9702-41-ALA26-Q2a";

export default function ThermalQuestion2a() {
...
Mark scheme:
- B1 mark 1: there are no intermolecular forces so no potential energy
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "no intermolecular forces", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/thermal/q2bi",
        nextRetryRoute: "/thermal/q2a",
        backRoute: "/",
        paperRef: PAPER_REF,
      }
    });
