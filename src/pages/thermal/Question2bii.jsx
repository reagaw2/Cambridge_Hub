...
const QUESTION = {
  ...
  text: "In the expression EK = (3/2)kT, state the meaning of the symbol T.",
  marks: "[1 mark]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "thermal_physics";
const QUESTION_ID = "9702-41-ALA26-Q2bii";

export default function ThermalQuestion2bii() {
...
Question: State the meaning of the symbol T in the expression EK = (3/2)kT.
Mark scheme:
- B1 mark 1: kelvin / thermodynamic / absolute temperature
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "kelvin / thermodynamic / absolute temperature", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/thermal/q3a",
        nextRetryRoute: "/thermal/q2bii",
        backRoute: "/thermal/q2bi",
        paperRef: PAPER_REF,
      }
    });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/thermal/q2bi")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
