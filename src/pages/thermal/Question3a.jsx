...
const QUESTION_ID = "9702-41-ALA26-Q3a";

export default function ThermalQuestion3a() {
...
- B1 mark 2: heat transfer occurs at constant temperature
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "energy per unit mass to change state", "found": true or false, "feedback": "one sentence explanation" },
  "mark_2": { "earned": true or false, "keyword": "constant temperature", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextFullRoute: "/thermal/q3bii",
        nextRetryRoute: "/thermal/q3a",
        backRoute: "/thermal/q2bii",
        paperRef: PAPER_REF,
      }
    });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/thermal/q2bii")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
