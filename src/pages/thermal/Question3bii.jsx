...
const QUESTION = {
  label: "Question 3(b)(ii)",
  topic: "Thermal Physics",
  text: "Explain why, although the power of the heater is changed, the rate of loss of thermal energy to the surroundings may be assumed to be constant.",
  marks: "[1 mark]",
};
const PAPER_REF = "9702/41 · ALA Mock Apr 2026";
const TOPIC_KEY = "thermal_physics";
const QUESTION_ID = "9702-41-ALA26-Q3bii";

export default function ThermalQuestion3bii() {
...
Question: Explain why, although the power of the heater is changed, the rate of loss of thermal energy to the surroundings may be assumed to be constant.
Mark scheme:
- B1 mark 1: the temperature difference between the liquid and the surroundings does not change so the rate of heat loss is the same
...
Analyse the student's answer against the mark scheme. Respond in the following JSON format only, no extra text:
{
  ...
  "mark_1": { "earned": true or false, "keyword": "temperature difference between liquid and surroundings does not change", "found": true or false, "feedback": "one sentence explanation" },
  ...
  "next_step": "one sentence telling the student exactly what to focus on in their next attempt"
    ...
    navigate("/feedback", {
      state: {
        ...
        nextRetryRoute: "/thermal/q3bii",
        backRoute: "/thermal/q3a",
        paperRef: PAPER_REF,
      }
    });
  };
    ...
    <div className="min-h-screen bg-background flex justify-center">
      <div className="w-full max-w-[480px] flex flex-col min-h-screen">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
          <button onClick={() => navigate("/thermal/q3a")} className="p-1.5 -ml-1.5 rounded-lg hover:bg-secondary transition-colors">
